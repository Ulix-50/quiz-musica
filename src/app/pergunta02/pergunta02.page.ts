...
@Component({
  selector: 'app-pergunta02',
  templateUrl: './pergunta02.page.html',
  styleUrls: ['./pergunta02.page.scss'],
})
export class Pergunta02Page implements OnInit {
        ...
        buttons: [
          {
            text: 'OK',
            handler: (data) => {
              this.gerenciadorNav.navigateForward('pergunta03');
            },
          },
        ],
