...
@Component({
  selector: 'app-pergunta07',
  templateUrl: './pergunta07.page.html',
  styleUrls: ['./pergunta07.page.scss'],
})
export class Pergunta07Page implements OnInit {
        ...
        buttons: [
          {
            text: 'OK',
            handler: (data) => {
              this.gerenciadorNav.navigateForward('pergunta08');
            },
          },
        ],
