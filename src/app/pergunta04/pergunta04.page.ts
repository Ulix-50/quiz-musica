...
@Component({
  selector: 'app-pergunta04',
  templateUrl: './pergunta04.page.html',
  styleUrls: ['./pergunta04.page.scss'],
})
export class Pergunta04Page implements OnInit {
        ...
        buttons: [
          {
            text: 'OK',
            handler: (data) => {
              this.gerenciadorNav.navigateForward('pergunta05');
            },
          },
        ],
