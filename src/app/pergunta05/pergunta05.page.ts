...
@Component({
  selector: 'app-pergunta05',
  templateUrl: './pergunta05.page.html',
  styleUrls: ['./pergunta05.page.scss'],
})
export class Pergunta05Page implements OnInit {
        ...
        buttons: [
          {
            text: 'OK',
            handler: (data) => {
              this.gerenciadorNav.navigateForward('pergunta06');
            },
          },
        ],
