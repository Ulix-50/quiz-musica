...
@Component({
  ...
  templateUrl: './pergunta01.page.html',
  styleUrls: ['./pergunta01.page.scss'],
})
export class Pergunta01Page implements OnInit {
        ...
        buttons: [
          {
            text: 'OK',
            handler: (data) => {
              this.gerenciadorNav.navigateForward('pergunta02');
            },
          },
        ],
