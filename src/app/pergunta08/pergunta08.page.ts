...
@Component({
  selector: 'app-pergunta08',
  templateUrl: './pergunta08.page.html',
  styleUrls: ['./pergunta08.page.scss'],
})
export class Pergunta08Page implements OnInit {
        ...
        buttons: [
          {
            text: 'OK',
            handler: (data) => {
              this.gerenciadorNav.navigateForward('pergunta09');
            },
          },
        ],
